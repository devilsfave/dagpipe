"""DagPipe — Constrained Generation
...
No hard dependency on outlines — falls back to pydantic_retry automatically.
"""
import json
...
def constrained_generate(
    ...
    **llm_kwargs,
    ...
    Args:
        ...
        mode: Generation mode — "pydantic_retry" (default) or "outlines".
...
def _generate_outlines(
    ...
    **llm_kwargs,
    ...
    try:
        ...
        # Outlines remote API integration with OpenAI-compatible endpoints
        # is still evolving. When stable, wire up here:
        #   from outlines import models, generate
        #   model = models.openai(api_url=endpoint_url, model="tgi")
